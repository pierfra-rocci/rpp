...
def parseArguments():
    ...
    # Print version
    parser.add_argument("--version", action="version", version='%(prog)s - Version 1.0') #TODO: get version from file
...
def main():
    ...
    sources_in_target_image = astrometry_old.find_sources(image, only_rectangle=only_rectangle, cutouts=args.cutout , sigma_threshold_for_source_detection=args.detection_threshold)
    ...
    catalog_from_obs["mag"]= -1.* sources_in_target_image["aperture_sum"]
